package com.slatmate.user.view.adapter
...
class CategoryAdapter(
    ...
    RecyclerView.Adapter<CategoryAdapter.FeedViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): CategoryAdapter.FeedViewHolder {
    ...
    override fun onBindViewHolder(holder: CategoryAdapter.FeedViewHolder, position: Int) {
