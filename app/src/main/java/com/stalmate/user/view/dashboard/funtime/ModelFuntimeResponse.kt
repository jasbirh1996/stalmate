...
data class ResultFuntime(
    ...
    var tag_id: String? = "",
    var tag_user: @RawValue ArrayList<TaggedUser>? = arrayListOf(),
    var text: String? = "", // Hi
    ...
    fun isImage(): Boolean {
        return ((file_type?.contains("0", true) == true) ||
                (file_type?.contains("image", true) == true) ||
                (file_type?.contains("png", true) == true) ||
                (file_type?.contains("jpg", true) == true) ||
                (file_type?.contains("jpeg", true) == true))
    }
