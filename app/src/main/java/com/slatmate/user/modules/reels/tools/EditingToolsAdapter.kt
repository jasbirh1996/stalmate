package com.slatmate.user.modules.reels.tools;
...
import com.user.vaibhavmodules.reels.tools.ToolType
...
class EditingToolsAdapter(private val mOnItemSelected: OnItemSelected) :
    ...
    init {
        mToolList.add(ToolModel("Shape", R.drawable.color_filter_icon, ToolType.SHAPE))
