...
class Mp4ComposerEngine {
    ...
    private static MediaFormat createVideoFormat(@NonNull final String mimeType,
        ...
        Log.d("bitrateee",String.valueOf(bitrate));
        Log.d("bitrateeeMime",String.valueOf(mimeType));
        Log.d("bitrateeeMime",String.valueOf(outputResolution.getWidth()));
        Log.d("bitrateeeMime",String.valueOf( outputResolution.getHeight()));


     Log.d("bitratee","Video size is " + outputFormat.getInteger(MediaFormat.KEY_WIDTH) + "x"+
