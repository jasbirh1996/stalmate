...
//            reset();
    ...
    // احسب النسبة التي يجب تكبير العرض عليها. القيمة المرجعة هي القيمة المباشرة من 0 إلى 1. تشير 1 إلى أن العنصر يساوي الحجم العادي ، و 0 هو أكبر عنصر.
    ...
    private void fillWithVertical(RecyclerView.Recycler recycler, RecyclerView.State state, int dy) {
        ...
        if (dy >= 0) {
            ...
            if (getChildCount() > 0) {
                ...
                startPosition = getPosition(firstView) - 1; // موضع العرض السابق
