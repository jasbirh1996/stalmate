...
import com.stalmate.user.databinding.ActivityLeftMenuSavedFuntimeBinding

class ActivityLeftMenuSavedFuntime : BaseActivity() {
    lateinit var binding:ActivityLeftMenuSavedFuntimeBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
     ...
     binding=DataBindingUtil.setContentView(this,R.layout.activity_left_menu_saved_funtime)
        setUpNavigation()
    }
...
/*           val arguments=NavArgument.Builder().setDefaultValue("Hello").build()
        ...
        if (intent.getStringExtra("viewType")!=null && intent.getStringExtra("viewType")=="viewFullScreen"){
            ...
            if (intent.getStringExtra("imageId")!=null){
                graph.addArgument("imageId",
                    NavArgument.Builder().setDefaultValue(intent.getStringExtra("imageId")!!.toString()).build())
            }else{
