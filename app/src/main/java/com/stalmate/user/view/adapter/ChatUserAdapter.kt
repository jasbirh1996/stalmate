...
class ChatUserAdapter(
    ...
    RecyclerView.Adapter<ChatUserAdapter.FeedViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): ChatUserAdapter.FeedViewHolder {
    ...
    override fun onBindViewHolder(holder: ChatUserAdapter.FeedViewHolder, position: Int) {
